		...
		<div class="row-fluid">
            ...
            <div class="span9">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="applicant" class="input-xlarge req_fields">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="firstname" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="middlename" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="lastname" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="radio"  name="gender" value="male" size="35" class="input-xlarge req_fields" id="gender11" /><span class="gender_label">Male</span>
                      
                        <input type="radio" name="gender" value="female" size="35" class="input-xlarge req_fields" id="gender22" /><span class="gender_label">Female</span>
                        
                         <input type="radio" name="gender" value="transgender" size="35" class="input-xlarge req_fields" id="gender22" /><span class="gender_label">Transgender</span>
                 ...
                 <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="age" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                 ...
                 <div class="control-group">
                   ...
                   <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="house_no" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                    ...
                    <div class="controls">
                    <input type="text" name="street" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                    ...
                    <div class="controls">
                    <input type="text" name="landmark" value="" size="35" class="input-xlarge req_fields" Placeholder="Please Type here" />
                    </div>
                 </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" Placeholder="Please Type here" name="area" value="" size="35" class="input-xlarge req_fields" />
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                    <input type="text" name="city" size="60" class="input-xlarge req_fields" id="city" value="" Placeholder="Please Type here"  />
               ...
               <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="email" size="60" class="input-xlarge" id="cemail" value=""  Placeholder="Please Type here" />
